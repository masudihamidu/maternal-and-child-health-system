<html>
    ...
    <div>
        <div class="container-fluid m-0 d-flex p2">
...
<!-- avatar -->
            ...
            <div class="text-white font-weight-bold m1-2">
<!-- word after avatar means name -->
            </div>

        </div>

        <div style="background: #061128; height: 2px;">
...
<script>
    ...
    $('#button-submit').on('click', function(){
        ...
        <div class="d-flex mb-2">
            ...
            <div class="text-white px-3 py-2" style="width: 270px; background: #13254b; border-radius:10px; font-size:85px;">
            `+data+`
            </div>
        </div>`)
        $value = $('#input').val('');
