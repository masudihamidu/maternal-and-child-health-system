...
<body style="background: #05113b;">
    <div>
        <div class="container-fluid m-0 d-flex p-2">
            <div class="p-2" style="width: 40px; height: 50px; font-size: 180%;"></div>
            <div style="width: 50px; height: 50px">
                <!-- avatar -->
            </div>
            <div class="text-white font-weight-bold m-2">
        ...
        <div class="container-fluid w-100 px-3 py-2 d-flex" style="background: #131f45; height: 62px;">
            <div class="mr-2 p-2" style="background: #ffffff1c; width: calc(100% - 45px); border-radius: 5px;">
