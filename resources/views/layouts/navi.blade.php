                                    ...
                                    <div class="header-top-menu tabl-d-n">
                                        <ul class="nav navbar-nav mai-top-nav">
                                            <li class="nav-item"><a href="{{ route('dashboard') }}"
                                                    class="nav-link">Nyumbani</a>
                                            </li>
                                            <li class="nav-item"><a
                                                    href="{{ route('registered_mothers.showRegisteredExpectant') }}"
                                                    class="nav-link">Mama Watarajiwa</a>
                                            </li>
                                            <li class="nav-item"><a href="{{ route('generatePdfReport') }}"
                                                    class="nav-link">Ripoti ya siku</a>
                                            </li>
